    ...
    return (
        <footer className="mt-16 border-t pb-24 md:pb-10">
            <div className="mx-auto max-w-7xl px-4 py-10 text-sm text-gray-600">
                © {new Date().getFullYear()} Expert Vakeel · Developed By <a href="https://www.digontom.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Digontom</a>
            </div>
        </footer>
    );
}
