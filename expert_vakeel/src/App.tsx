...
export const apiService = {
  clients: {
    ...
    update: (id: Id, data: Record<string, unknown>) =>
  ...
  news: {
    ...
    incrementViews: (id: Id) =>
      request(`/api/news/${id}/views/increment`, { method: "POST" }),
  },
  general: {
    getApiInfo: () => request("/"),
